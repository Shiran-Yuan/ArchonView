...
class Args(Tap):
    ...
    mid_reso: float = 1.0     # aug: first resize to mid_reso = 1.125 * data_load_reso, then crop to data_load_reso
...
def init_dist_and_get_args():
    ...
    args.last_ckpt_path = os.path.join(args.local_out_dir_path, f'ar-ckpt-1.pth')
